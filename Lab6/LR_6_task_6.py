...
def get_recommendations(dataset, input_user):
    ...
    # Обчислення оцінки подібності між вказаним користувачем та всіма іншими користувачами у наборі даних.
    for user in [x for x in dataset if x != input_user]:
        ...
        # Вилучення списку фільмів, що вже отримали рейтингову оцінку від поточного користувача, але ще не оцінених
